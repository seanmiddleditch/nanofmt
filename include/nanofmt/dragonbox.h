...
// Copied to nanofmt from upstream commit 5cf1d3f92f837272517e8e9e13cf9c6162c2e964
// - Adjusted namespaces and macros to avoid downstream linking issues

#ifndef NANOFMT_HEADER_DRAGONBOX
#define NANOFMT_HEADER_DRAGONBOX
...
#    define NANOFMT_HAS_CONSTEXPR14 1
#elif __cplusplus >= 201402L
#    define NANOFMT_HAS_CONSTEXPR14 1
#elif defined(_MSC_VER) && _MSC_VER >= 1910 && _MSVC_LANG >= 201402L
#    define NANOFMT_HAS_CONSTEXPR14 1
#else
#    define NANOFMT_HAS_CONSTEXPR14 0
#endif

#if NANOFMT_HAS_CONSTEXPR14
#    define NANOFMT_CONSTEXPR14 constexpr
#else
#    define NANOFMT_CONSTEXPR14
#endif

// C++17 constexpr lambdas
#if defined(__cpp_constexpr) && __cpp_constexpr >= 201603L
#    define NANOFMT_HAS_CONSTEXPR17 1
#elif __cplusplus >= 201703L
#    define NANOFMT_HAS_CONSTEXPR17 1
#elif defined(_MSC_VER) && _MSC_VER >= 1911 && _MSVC_LANG >= 201703L
#    define NANOFMT_HAS_CONSTEXPR17 1
#else
#    define NANOFMT_HAS_CONSTEXPR17 0
#endif

// C++17 inline variables
#if defined(__cpp_inline_variables) && __cpp_inline_variables >= 201606L
#    define NANOFMT_HAS_INLINE_VARIABLE 1
#elif __cplusplus >= 201703L
#    define NANOFMT_HAS_INLINE_VARIABLE 1
#elif defined(_MSC_VER) && _MSC_VER >= 1912 && _MSVC_LANG >= 201703L
#    define NANOFMT_HAS_INLINE_VARIABLE 1
#else
#    define NANOFMT_HAS_INLINE_VARIABLE 0
#endif

#if NANOFMT_HAS_INLINE_VARIABLE
#    define NANOFMT_INLINE_VARIABLE inline constexpr
#else
#    define NANOFMT_INLINE_VARIABLE static constexpr
#endif

// C++17 if constexpr
#if defined(__cpp_if_constexpr) && __cpp_if_constexpr >= 201606L
#    define NANOFMT_HAS_IF_CONSTEXPR 1
#elif __cplusplus >= 201703L
#    define NANOFMT_HAS_IF_CONSTEXPR 1
#elif defined(_MSC_VER) && _MSC_VER >= 1911 && _MSVC_LANG >= 201703L
#    define NANOFMT_HAS_IF_CONSTEXPR 1
#else
#    define NANOFMT_HAS_IF_CONSTEXPR 0
#endif

#if NANOFMT_HAS_IF_CONSTEXPR
#    define NANOFMT_IF_CONSTEXPR if constexpr
#else
#    define NANOFMT_IF_CONSTEXPR if
#endif
...
#else
#    define NANOFMT_HAS_BIT_CAST 0
#endif

// C++23 if consteval or C++20 std::is_constant_evaluated
#if defined(__cpp_if_consteval) && __cpp_is_consteval >= 202106L
#    define NANOFMT_IF_CONSTEVAL if consteval
#    define NANOFMT_IF_NOT_CONSTEVAL if !consteval
#    define NANOFMT_CAN_BRANCH_ON_CONSTEVAL 1
#elif defined(__cpp_lib_is_constant_evaluated) && __cpp_lib_is_constant_evaluated >= 201811L
#    define NANOFMT_IF_CONSTEVAL if (std::is_constant_evaluated())
#    define NANOFMT_IF_NOT_CONSTEVAL if (!std::is_constant_evaluated())
#    define NANOFMT_CAN_BRANCH_ON_CONSTEVAL 1
#elif NANOFMT_HAS_IF_CONSTEXPR
#    define NANOFMT_IF_CONSTEVAL if constexpr (false)
#    define NANOFMT_IF_NOT_CONSTEVAL if constexpr (true)
#    define NANOFMT_CAN_BRANCH_ON_CONSTEVAL 0
#else
#    define NANOFMT_IF_CONSTEVAL if (false)
#    define NANOFMT_IF_NOT_CONSTEVAL if (true)
#    define NANOFMT_CAN_BRANCH_ON_CONSTEVAL 0
#endif

#if NANOFMT_CAN_BRANCH_ON_CONSTEVAL && NANOFMT_HAS_BIT_CAST
#    define NANOFMT_CONSTEXPR20 constexpr
#else
#    define NANOFMT_CONSTEXPR20
#endif
...
#    define NANOFMT_SAFEBUFFERS
#    define NANOFMT_FORCEINLINE inline __attribute__((always_inline))
#elif defined(_MSC_VER)
#    define NANOFMT_SAFEBUFFERS __declspec(safebuffers)
#    define NANOFMT_FORCEINLINE __forceinline
#else
#    define NANOFMT_SAFEBUFFERS
#    define NANOFMT_FORCEINLINE inline
#endif

#if defined(__has_builtin)
#    define NANOFMT_HAS_BUILTIN(x) __has_builtin(x)
#else
#    define NANOFMT_HAS_BUILTIN(x) false
#endif
...
namespace NANOFMT_NS {
    namespace dragonbox {
        ...
        namespace detail {
            ...
            NANOFMT_CONSTEXPR20 To bit_cast(const From& from) {
#if NANOFMT_HAS_BIT_CAST
        ...
        struct default_float_traits {
            ...
            using format = typename std::
                conditional<detail::physical_bits<T>::value == 32, ieee754_binary32, ieee754_binary64>::type;
            ...
            static NANOFMT_CONSTEXPR20 T carrier_to_float(carrier_uint u) noexcept {
                return detail::bit_cast<T>(u);
            }

            // Same as above.
            static NANOFMT_CONSTEXPR20 carrier_uint float_to_carrier(T x) noexcept {
            ...
            static constexpr carrier_uint binary_significand(
                carrier_uint significand_bits,
                unsigned int exponent_bits) noexcept {
                return exponent_bits == 0 ? significand_bits
        ...
        struct float_bits {
            ...
            // Remove the exponent bits and extract significand bits together with the sign bit.
            constexpr signed_significand_bits<type, traits_type> remove_exponent_bits(
        ...
        namespace detail {
            ...
            namespace bits {
                ...
                inline NANOFMT_CONSTEXPR14 std::uint32_t rotr(std::uint32_t n, std::uint32_t r) noexcept {
                    r &= 31;
                    return (n >> r) | (n << (32 - r));
                }
                inline NANOFMT_CONSTEXPR14 std::uint64_t rotr(std::uint64_t n, std::uint32_t r) noexcept {
                    r &= 63;
                    return (n >> r) | (n << (64 - r));
                }
            } // namespace bits
		...
		// [-Wpedantic]"
			...
			using builtin_uint128_t = unsigned __int128;
                ...
                struct uint128 {
                    ...
                    NANOFMT_CONSTEXPR20 uint128& operator+=(std::uint64_t n) & noexcept {
                        auto const generic_impl = [&] {
                            auto sum = low_ + n;
                            high_ += (sum < low_ ? 1 : 0);
                            low_ = sum;
                        };
                        NANOFMT_IF_CONSTEVAL {
                            generic_impl();
                            return *this;
                        }
#if NANOFMT_HAS_BUILTIN(__builtin_addcll)
                        unsigned long long carry{};
                        low_ = __builtin_addcll(low_, n, 0, &carry);
                        high_ = __builtin_addcll(high_, 0, carry, &carry);
#elif NANOFMT_HAS_BUILTIN(__builtin_ia32_addcarryx_u64)
                ...
                inline NANOFMT_CONSTEXPR20 std::uint64_t umul64(std::uint32_t x, std::uint32_t y) noexcept {
#if defined(_MSC_VER) && defined(_M_IX86)
                    NANOFMT_IF_NOT_CONSTEVAL {
                        return __emulu(x, y);
                    }
#endif
                ...
                NANOFMT_SAFEBUFFERS inline NANOFMT_CONSTEXPR20 uint128 umul128(std::uint64_t x, std::uint64_t y) noexcept {
                ...
                NANOFMT_SAFEBUFFERS inline NANOFMT_CONSTEXPR20 std::uint64_t umul128_upper64(
                    std::uint64_t x,
                ...
                // unsigned integer.
                NANOFMT_SAFEBUFFERS inline NANOFMT_CONSTEXPR20 uint128 umul192_upper128(std::uint64_t x, uint128 y) noexcept {
                ...
                // unsigned integer.
                inline NANOFMT_CONSTEXPR20 std::uint64_t umul96_upper64(std::uint32_t x, std::uint64_t y) noexcept {
                ...
                // unsigned integer.
                NANOFMT_SAFEBUFFERS inline NANOFMT_CONSTEXPR20 uint128 umul192_lower128(std::uint64_t x, uint128 y) noexcept {
                    auto high = x * y.high();
            ...
            namespace div {
                ...
                template <int N>
                NANOFMT_CONSTEXPR14 bool check_divisibility_and_divide_by_pow10(std::uint32_t& n) noexcept {
                ...
                // Precondition: n <= 10^(N+1)
                template <int N>
                NANOFMT_CONSTEXPR14 std::uint32_t small_division_by_pow10(std::uint32_t n) noexcept {
                    // Make sure the computation for max_n does not overflow.
                    static_assert(N + 1 <= log::floor_log10_pow2(31), "");
                    assert(n <= compute_power<N + 1>(std::uint32_t(10)));
                ...
                NANOFMT_CONSTEXPR20 UInt divide_by_pow10(UInt n) noexcept {
                    static_assert(N >= 0, "");
                    ...
                    NANOFMT_IF_CONSTEXPR(std::is_same<UInt, std::uint32_t>::value && N == 2) {
                        return std::uint32_t(wuint::umul64(n, std::uint32_t(1374389535)) >> 37);
                    }
                    // Specialize for 64-bit division by 1000.
                    // Ensure that the correctness condition is met.
                    else NANOFMT_IF_CONSTEXPR(
        ...
        template <class UInt>
        constexpr signed_decimal_fp<UInt, false> add_sign_to_unsigned_decimal_fp(
            bool is_negative,
            unsigned_decimal_fp<UInt, false> r) noexcept {
            return {r.significand, r.exponent, is_negative};
        }

        template <class UInt>
        constexpr signed_decimal_fp<UInt, true> add_sign_to_unsigned_decimal_fp(
            bool is_negative,
            unsigned_decimal_fp<UInt, true> r) noexcept {
        ...
        namespace detail {
            ...
            struct compressed_cache_detail {
                ...
                static constexpr cache_holder_t cache = make_cache_table(make_index_sequence<compressed_table_size>{});

                template <std::size_t... indices>
                static constexpr pow5_holder_t make_pow5_table(index_sequence<indices...>) {
                    return {compute_power<indices>(std::uint64_t(5))...};
                }
                static constexpr pow5_holder_t pow5 = make_pow5_table(make_index_sequence<compression_ratio>{});
#endif
            };
#if !NANOFMT_HAS_INLINE_VARIABLE
            template <class Dummy>
            constexpr typename compressed_cache_detail<Dummy>::cache_holder_t compressed_cache_detail<Dummy>::cache;
            template <class Dummy>
            constexpr typename compressed_cache_detail<Dummy>::pow5_holder_t compressed_cache_detail<Dummy>::pow5;
#endif
        } // namespace detail
            ...
            namespace policy_impl {
                ...
                namespace sign {
                    ...
                    struct ignore : base {
                        ...
                        static constexpr UnsignedDecimalFp handle_sign(
                    ...
                    struct return_sign : base {
                        ...
                        template <class SignedSignificandBits, class UnsignedDecimalFp>
                        static constexpr unsigned_decimal_fp_to_signed_t<UnsignedDecimalFp> handle_sign(
                ...
                namespace trailing_zero {
                    ...
                    struct ignore : base {
                        ...
                        static constexpr ReturnType on_trailing_zeros(
                            typename Impl::carrier_uint significand,
                            int exponent) noexcept {
                            return {significand, exponent};
                        }

                        template <class Impl, class ReturnType>
                        static constexpr ReturnType no_trailing_zeros(
                            typename Impl::carrier_uint significand,
                            int exponent) noexcept {
                            return {significand, exponent};
                        }
                    ...
                    struct remove : base {
                        ...
                        template <class Impl, class ReturnType>
                        NANOFMT_FORCEINLINE static constexpr ReturnType on_trailing_zeros(
                            typename Impl::carrier_uint significand,
                            int exponent) noexcept {
                ...
                namespace decimal_to_binary_rounding {
                    ...
                    struct nearest_to_even : base {
                        ...
                        NANOFMT_FORCEINLINE NANOFMT_SAFEBUFFERS static constexpr decltype(Func{}(
                            declval<nearest_to_even>(),
                            Args{}...))
                        ...
                        template <class SignedSignificandBits, class Func, class... Args>
                        NANOFMT_FORCEINLINE NANOFMT_SAFEBUFFERS static constexpr decltype(Func{}(Args{}..., false))
                        invoke_normal_interval_case(SignedSignificandBits s, Func f, Args... args) noexcept {
                            return f(args..., s.has_even_significand_bits());
                        }
                        template <class SignedSignificandBits, class Func, class... Args>
                        NANOFMT_FORCEINLINE NANOFMT_SAFEBUFFERS static constexpr decltype(Func{}(Args{}...))
                        invoke_shorter_interval_case(SignedSignificandBits, Func f, Args... args) noexcept {
                            return f(args...);
                        }
                    };
                    ...
                    struct nearest_toward_plus_infinity : base {
                        ...
                        template <class SignedSignificandBits, class Func, class... Args>
                        NANOFMT_FORCEINLINE NANOFMT_SAFEBUFFERS static constexpr decltype(Func{}(
                            declval<nearest_toward_plus_infinity>(),
                            Args{}...))
                        delegate(SignedSignificandBits, Func f, Args... args) noexcept {
                        ...
                        template <class SignedSignificandBits, class Func, class... Args>
                        NANOFMT_FORCEINLINE NANOFMT_SAFEBUFFERS static constexpr decltype(Func{}(Args{}..., false))
                        invoke_shorter_interval_case(SignedSignificandBits s, Func f, Args... args) noexcept {
                            return f(args..., !s.is_negative());
                        }
                    };
                    struct nearest_toward_minus_infinity : base {
                        ...
                        template <class SignedSignificandBits, class Func, class... Args>
                        NANOFMT_FORCEINLINE NANOFMT_SAFEBUFFERS static constexpr decltype(Func{}(
                            declval<nearest_toward_minus_infinity>(),
                            Args{}...))
                        delegate(SignedSignificandBits, Func f, Args... args) noexcept {
                    ...
                    struct nearest_toward_zero : base {
                        ...
                        template <class SignedSignificandBits, class Func, class... Args>
                        NANOFMT_FORCEINLINE NANOFMT_SAFEBUFFERS static constexpr decltype(Func{}(Args{}...))
                        invoke_normal_interval_case(SignedSignificandBits, Func f, Args... args) noexcept {
                            return f(args...);
                        }
                        template <class SignedSignificandBits, class Func, class... Args>
                        NANOFMT_FORCEINLINE NANOFMT_SAFEBUFFERS static constexpr decltype(Func{}(Args{}...))
                    ...
                    struct nearest_away_from_zero : base {
                        ...
                        template <class SignedSignificandBits, class Func, class... Args>
                        NANOFMT_FORCEINLINE NANOFMT_SAFEBUFFERS static constexpr decltype(Func{}(
                            declval<nearest_away_from_zero>(),
                            Args{}...))
                        delegate(SignedSignificandBits, Func f, Args... args) noexcept {
                    ...
                    struct nearest_to_even_static_boundary : base {
                        ...
                        template <class SignedSignificandBits, class Func, class... Args>
                        NANOFMT_FORCEINLINE NANOFMT_SAFEBUFFERS static constexpr decltype(Func{}(
                            detail::nearest_always_closed{},
                            Args{}...))
                        delegate(SignedSignificandBits s, Func f, Args... args) noexcept {
                            return s.has_even_significand_bits() ? f(detail::nearest_always_closed{}, args...)
                    ...
                    struct nearest_to_odd_static_boundary : base {
                        ...
                        NANOFMT_FORCEINLINE NANOFMT_SAFEBUFFERS static constexpr decltype(Func{}(
                            ...
                            Args{}...))
                        delegate(SignedSignificandBits s, Func f, Args... args) noexcept {
                            return s.has_even_significand_bits() ? f(detail::nearest_always_open{}, args...)
                ...
                namespace cache {
                    ...
                    struct full : base {
                        ...
                        static constexpr typename cache_holder<FloatFormat>::cache_entry_type get_cache(
                            int k) noexcept {
#if NANOFMT_HAS_CONSTEXPR14
                    ...
                    struct compact : base {
                        ...
                        struct get_cache_impl<ieee754_binary64, Dummy> {
                            static NANOFMT_CONSTEXPR20 cache_holder<ieee754_binary64>::cache_entry_type get_cache(
                                int k) noexcept {
                        ...
                        template <class FloatFormat>
                        static NANOFMT_CONSTEXPR20 typename cache_holder<FloatFormat>::cache_entry_type get_cache(
                            int k) noexcept {
                            assert(k >= cache_holder<FloatFormat>::min_k && k <= cache_holder<FloatFormat>::max_k);
        ...
        namespace policy {
            namespace sign {
                NANOFMT_INLINE_VARIABLE auto ignore = detail::policy_impl::sign::ignore{};
                NANOFMT_INLINE_VARIABLE auto return_sign = detail::policy_impl::sign::return_sign{};
            } // namespace sign

            namespace trailing_zero {
                NANOFMT_INLINE_VARIABLE auto ignore = detail::policy_impl::trailing_zero::ignore{};
                NANOFMT_INLINE_VARIABLE auto remove = detail::policy_impl::trailing_zero::remove{};
                NANOFMT_INLINE_VARIABLE auto report = detail::policy_impl::trailing_zero::report{};
            } // namespace trailing_zero

            namespace decimal_to_binary_rounding {
                NANOFMT_INLINE_VARIABLE auto nearest_to_even =
                    detail::policy_impl::decimal_to_binary_rounding::nearest_to_even{};
                NANOFMT_INLINE_VARIABLE auto nearest_to_odd =
                    detail::policy_impl::decimal_to_binary_rounding::nearest_to_odd{};
                NANOFMT_INLINE_VARIABLE auto nearest_toward_plus_infinity =
                    detail::policy_impl::decimal_to_binary_rounding::nearest_toward_plus_infinity{};
                NANOFMT_INLINE_VARIABLE auto nearest_toward_minus_infinity =
                    detail::policy_impl::decimal_to_binary_rounding::nearest_toward_minus_infinity{};
                NANOFMT_INLINE_VARIABLE auto nearest_toward_zero =
                ...
                NANOFMT_INLINE_VARIABLE auto nearest_to_even_static_boundary =
                    detail::policy_impl::decimal_to_binary_rounding::nearest_to_even_static_boundary{};
                NANOFMT_INLINE_VARIABLE auto nearest_to_odd_static_boundary =
                    detail::policy_impl::decimal_to_binary_rounding::nearest_to_odd_static_boundary{};
                NANOFMT_INLINE_VARIABLE auto nearest_toward_plus_infinity_static_boundary =
                ...
                NANOFMT_INLINE_VARIABLE auto toward_plus_infinity =
                    detail::policy_impl::decimal_to_binary_rounding::toward_plus_infinity{};
                NANOFMT_INLINE_VARIABLE auto toward_minus_infinity =
                    detail::policy_impl::decimal_to_binary_rounding::toward_minus_infinity{};
                NANOFMT_INLINE_VARIABLE auto toward_zero = detail::policy_impl::decimal_to_binary_rounding::toward_zero{};
                NANOFMT_INLINE_VARIABLE auto away_from_zero =
                    detail::policy_impl::decimal_to_binary_rounding::away_from_zero{};
            } // namespace decimal_to_binary_rounding

            namespace binary_to_decimal_rounding {
                NANOFMT_INLINE_VARIABLE auto do_not_care = detail::policy_impl::binary_to_decimal_rounding::do_not_care{};
                NANOFMT_INLINE_VARIABLE auto to_even = detail::policy_impl::binary_to_decimal_rounding::to_even{};
                NANOFMT_INLINE_VARIABLE auto to_odd = detail::policy_impl::binary_to_decimal_rounding::to_odd{};
                NANOFMT_INLINE_VARIABLE auto away_from_zero =
            ...
            namespace cache {
                NANOFMT_INLINE_VARIABLE auto full = detail::policy_impl::cache::full{};
                NANOFMT_INLINE_VARIABLE auto compact = detail::policy_impl::cache::compact{};
            } // namespace cache
        } // namespace policy
        ...
        namespace detail {
            ...
            struct impl
                ...
                static constexpr int min_k =
                    min(-log::floor_log10_pow2_minus_log10_4_over_3(int(max_exponent - significand_bits)),
                ...
                static constexpr int max_k =
                    max(-log::floor_log10_pow2_minus_log10_4_over_3(int(min_exponent - significand_bits /*+ 1*/)),
                ...
                template <
                    ...
                    class BinaryToDecimalRoundingPolicy,
                    class CachePolicy,
                    class... AdditionalArgs>
                NANOFMT_FORCEINLINE NANOFMT_SAFEBUFFERS static NANOFMT_CONSTEXPR20 ReturnType compute_nearest_normal(
                    carrier_uint const two_fc,
                    int const binary_exponent,
                    ...
                    carrier_uint decimal_significand = div::divide_by_pow10<
                        kappa + 1,
                        carrier_uint,
                        (carrier_uint(1) << (significand_bits + 1)) * big_divisor - 1>(z_result.integer_part);
                    auto r = std::uint32_t(z_result.integer_part - big_divisor * decimal_significand);

                    do {
                        if (r < deltai) {
                            // Exclude the right endpoint if necessary.
                            if (r == 0 && (z_result.is_integer & !interval_type.include_right_endpoint())) {
                                NANOFMT_IF_CONSTEXPR(
                ...
                template <
                    ...
                    class CachePolicy,
                    class... AdditionalArgs>
                NANOFMT_SAFEBUFFERS static NANOFMT_CONSTEXPR20 ReturnType
                compute_nearest_shorter(int const binary_exponent, AdditionalArgs... additional_args) noexcept {
                    IntervalType interval_type{additional_args...};
                    ...
                    decimal_significand =
                        compute_mul_impl<format>::compute_round_up_for_shorter_interval_case(cache, beta);
                ...
                NANOFMT_FORCEINLINE NANOFMT_SAFEBUFFERS static NANOFMT_CONSTEXPR20 ReturnType
                compute_left_closed_directed(carrier_uint const two_fc, int binary_exponent) noexcept {
                    ...
                    // = 1.2288530660000000001731007559513386695471126586198806762695... * 10^-17
                    // for binary32.
                    NANOFMT_IF_CONSTEXPR(std::is_same<format, ieee754_binary32>::value) {
                    ...
                    carrier_uint decimal_significand = div::divide_by_pow10<
                        kappa + 1,
                        carrier_uint,
                        (carrier_uint(1) << (significand_bits + 1)) * big_divisor - 1>(x_result.integer_part);
                ...
                template <class ReturnType, class TrailingZeroPolicy, class CachePolicy>
                NANOFMT_FORCEINLINE NANOFMT_SAFEBUFFERS static NANOFMT_CONSTEXPR20 ReturnType compute_right_closed_directed(
                    carrier_uint const two_fc,
                    int const binary_exponent,
                    ...
                    // Compute zi and deltai.
                    // 10^kappa <= deltai < 10^(kappa + 1)
                    auto const deltai = shorter_interval ? compute_mul_impl<format>::compute_delta(cache, beta - 1)
                ...
                NANOFMT_FORCEINLINE static NANOFMT_CONSTEXPR20 int remove_trailing_zeros(carrier_uint& n) noexcept {
                    assert(n != 0);
                ...
                struct compute_mul_impl<ieee754_binary32, Dummy> {
                    static NANOFMT_CONSTEXPR20 compute_mul_result
                    ...
                    static NANOFMT_CONSTEXPR20 compute_mul_parity_result
                    ...
                    static constexpr carrier_uint compute_right_endpoint_for_shorter_interval_case(
                        ...
                        int beta) noexcept {
                        return carrier_uint(
                            (cache + (cache >> (significand_bits + 1))) >> (cache_bits - significand_bits - 1 - beta));
                    }
            ...
            namespace policy_impl {
                ...
                using policy_pair_list =
                    typename make_policy_holder_impl<BaseDefaultPairList, found_policy_pair_list<false>, Policies...>::
                        type;
                ...
                make_policy_holder(BaseDefaultPairList, Policies... policies) {
                    static_assert(
                        ...
                        "nanofmt::dragonbox: an invalid policy is specified");

                    static_assert(
                        !policy_pair_list<BaseDefaultPairList, Policies...>::repeated,
                        "nanofmt::dragonbox: each policy should be specified at most once");
            ...
            using to_decimal_policy_holder = decltype(policy_impl::make_policy_holder(
                policy_impl::base_default_pair_list<
                    ...
                    policy_impl::
                        base_default_pair<policy_impl::trailing_zero::base, policy_impl::trailing_zero::remove>,
                    ...
                    policy_impl::base_default_pair<
                        policy_impl::binary_to_decimal_rounding::base,
            ...
            using to_decimal_return_type = decimal_fp<
            ...
            struct invoke_shorter_dispatcher {
                using unsigned_return_type =
                    decimal_fp<typename FloatTraits::carrier_uint, false, PolicyHolder::report_trailing_zeros>;

                template <class... Args>
                NANOFMT_FORCEINLINE NANOFMT_SAFEBUFFERS NANOFMT_CONSTEXPR20 unsigned_return_type operator()(Args... args) noexcept {
            ...
            template <class Float, class FloatTraits, class PolicyHolder, class IntervalTypeProvider>
            NANOFMT_SAFEBUFFERS NANOFMT_CONSTEXPR20 decimal_fp<
                typename FloatTraits::carrier_uint,
                PolicyHolder::return_has_sign,
            ...
            to_decimal_impl(
                ...
                NANOFMT_IF_CONSTEXPR(tag == decimal_to_binary_rounding::tag_t::to_nearest) {
                    ...
                    if (exponent != 0) {
                        ...
                        // length.
                        static_assert(
                            std::is_same<format, ieee754_binary32>::value ||
                ...
                else NANOFMT_IF_CONSTEXPR(tag == decimal_to_binary_rounding::tag_t::left_closed_directed) {
                    // Is the input a normal number?
                    if (exponent != 0) {
                        exponent += format::exponent_bias - format::significand_bits;
                        two_fc |= (decltype(two_fc)(1) << (format::significand_bits + 1));
            ...
            struct to_decimal_dispatcher {
                ...
                NANOFMT_FORCEINLINE NANOFMT_SAFEBUFFERS NANOFMT_CONSTEXPR20 return_type
        ...
        NANOFMT_FORCEINLINE NANOFMT_SAFEBUFFERS NANOFMT_CONSTEXPR20 detail::to_decimal_return_type<FloatTraits, Policies...>
        to_decimal(
            signed_significand_bits<Float, FloatTraits> signed_significand_bits,
...
#undef NANOFMT_HAS_BUILTIN
#undef NANOFMT_FORCEINLINE
#undef NANOFMT_SAFEBUFFERS
#undef NANOFMT_CONSTEXPR20
#undef NANOFMT_CAN_BRANCH_ON_CONSTEVAL
#undef NANOFMT_IF_NOT_CONSTEVAL
#undef NANOFMT_IF_CONSTEVAL
#undef NANOFMT_HAS_BIT_CAST
#undef NANOFMT_IF_CONSTEXPR
#undef NANOFMT_HAS_IF_CONSTEXPR
#undef NANOFMT_INLINE_VARIABLE
#undef NANOFMT_HAS_INLINE_VARIABLE
#undef NANOFMT_HAS_CONSTEXPR17
#undef NANOFMT_CONSTEXPR14
#undef NANOFMT_HAS_CONSTEXPR14
