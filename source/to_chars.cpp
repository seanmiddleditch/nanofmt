...
char* nanofmt::to_chars(char* buffer, char const* end, unsigned char value, int_format fmt) noexcept {
    return detail::to_chars_impl(buffer, end, value, fmt);
}

char* nanofmt::to_chars(char* buffer, char const* end, signed short value, int_format fmt) noexcept {
    return detail::to_chars_impl(buffer, end, value, fmt);
}

char* nanofmt::to_chars(char* buffer, char const* end, unsigned short value, int_format fmt) noexcept {
    return detail::to_chars_impl(buffer, end, value, fmt);
}

char* nanofmt::to_chars(char* buffer, char const* end, signed int value, int_format fmt) noexcept {
    return detail::to_chars_impl(buffer, end, value, fmt);
}

char* nanofmt::to_chars(char* buffer, char const* end, unsigned int value, int_format fmt) noexcept {
    return detail::to_chars_impl(buffer, end, value, fmt);
}

char* nanofmt::to_chars(char* buffer, char const* end, signed long value, int_format fmt) noexcept {
    return detail::to_chars_impl(buffer, end, value, fmt);
}

char* nanofmt::to_chars(char* buffer, char const* end, unsigned long value, int_format fmt) noexcept {
    return detail::to_chars_impl(buffer, end, value, fmt);
}

char* nanofmt::to_chars(char* buffer, char const* end, signed long long value, int_format fmt) noexcept {
    return detail::to_chars_impl(buffer, end, value, fmt);
}

char* nanofmt::to_chars(char* buffer, char const* end, unsigned long long value, int_format fmt) noexcept {
    return detail::to_chars_impl(buffer, end, value, fmt);
}

char* nanofmt::to_chars(char* buffer, char const* end, float value, float_format fmt) noexcept {
    return detail::to_chars_impl<std::uint32_t>(buffer, end, value, fmt, -1);
}

char* nanofmt::to_chars(char* buffer, char const* end, double value, float_format fmt) noexcept {
    return detail::to_chars_impl<std::uint64_t>(buffer, end, value, fmt, -1);
}

char* nanofmt::to_chars(char* buffer, char const* end, float value, float_format fmt, int precision) noexcept {
    return detail::to_chars_impl<std::uint32_t>(buffer, end, value, fmt, precision);
}

char* nanofmt::to_chars(char* buffer, char const* end, double value, float_format fmt, int precision) noexcept {
...
char* nanofmt::detail::to_chars_impl(
    ...
    if (!std::isfinite(value)) {
        switch (fmt) {
            ...
            default:
                return to_chars_impl_nonfinite(buffer, end, std::signbit(value), std::isinf(value), /*upper=*/false);
        }
    }
...
char* nanofmt::detail::to_chars_impl_scientific(
    char* buffer,
    char const* end,
    CarrierT significand,
    int exponent,
...
char* nanofmt::detail::to_chars_impl_fixed(
    char* buffer,
    char const* end,
    CarrierT significand,
    int exponent,
...
char* nanofmt::detail::to_chars_impl_general(
    char* buffer,
    char const* end,
    CarrierT significand,
    int exponent,
...
char* nanofmt::detail::to_chars_impl_nonfinite(
    char* buffer,
    char const* end,
    bool negative,
    bool infinite,
