...
template <typename UnsignedIntT>
constexpr int nanofmt::detail::count_digits(UnsignedIntT value) noexcept {
...
//
template <typename UnsignedIntT>
constexpr UnsignedIntT nanofmt::detail::rshift10(UnsignedIntT value, int shift) noexcept {
    if constexpr (sizeof(UnsignedIntT) > 1) {
        while (shift >= 4) {
            value /= 10'000u;
            shift -= 4;
...
template <typename UnsignedIntT>
constexpr int nanofmt::detail::countl_zero(UnsignedIntT value) noexcept {
...
template <typename IntT>
constexpr auto nanofmt::detail::abs(IntT value) noexcept {
